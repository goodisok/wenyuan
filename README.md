...
输入公历或农历生辰即可排盘；程序综参子平诸家，AI 在命盘上下文中解读（**v1.3**）。
...
| 知识库 | 九家典籍可检索片段，自动锚定 AI 解读并标注出处（参考 [bazi-skill](https://github.com/jinchenma94/bazi-skill) MIT） |
...
当前 **v1.3.0** — 命理知识库、格局/喜用/神煞规则层、典籍锚定 AI。
...
**公网 Demo：** [http://119.91.54.153/](http://119.91.54.153/)（v1.3.0，部署后更新）
