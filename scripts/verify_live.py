...
def main() -> int:
    ...
    ok = code == 200 and health.get("status") == "ok" and health.get("version") == "1.8.2"
    ...
    pages = {
        "/": (
            TMP / "_tmp_home.html",
            ["page-home", 'class="hero"', "feature-card", "form-card", "开始排盘", "site-nav-link", "Wenyuan.initIndexPage", "theme.css?v=1.8.2"],
